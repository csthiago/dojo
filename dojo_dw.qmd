...
fruits |> group_by(fruit) |> mutate(across(height_1:height_3,mean))

fruits |> rowwise() |> mutate(mean_height=mean(height_1:height_3))
fruits |> rowwise() |> mutate(mean_height=mean(c(height_1:height_3)))

fruits |> rowwise() |> mutate(mean_height=mean(c(height_1, height_2,height_3)))

#c_across

fruits |> rowwise() |> mutate(mean_height=mean(c_across(starts_with("height"))))
